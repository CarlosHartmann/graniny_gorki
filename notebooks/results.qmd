...
```{python}
# The relevant numbers are: overall human mean, culled human mean, and the mean of all runs of the top 3 LLMs.
# create a dict that contains these 5 numbers
...
labels = ["Overall\nHuman Mean", "Culled\nHuman Mean"] + top_3_llms_namemapped
values = [hypothesis_2_results["overall_human_mean"], hypothesis_2_results["culled_human_mean"]] + [acc for _, acc in reversed(top_3_llms)]
colors = ["#82A5D5", "#477BBF", "#FF96A0", "#DD7778", "#C8494C"]
