...
* let GPT tell me when it accessed the context

* "treat different examples of same type as experimental condition" -- sounds good, figure out if makes sense in my case
...
* Assess explanations for quality, qualitatively
...
To determine the LLMs' accuracy in identifying context-dependency, the prompting strategy that includes the context URL was modified to additionally ask the LLM to declare whenever it decided to access the context to make its decision and to supply a brief reasoning for it.
